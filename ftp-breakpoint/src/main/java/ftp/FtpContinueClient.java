...
public class FtpContinueClient {
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            myFtp.connect("192.168.44.128", 2121, "admin", "admin");
//             myFtp.ftpClient.makeDirectory(new
//             String("555".getBytes("GBK"),"iso-8859-1"));
            // myFtp.ftpClient.changeWorkingDirectory(new
            // String("电视剧".getBytes("GBK"),"iso-8859-1"));
            // myFtp.ftpClient.makeDirectory(new
            // String("走西口".getBytes("GBK"),"iso-8859-1"));

//            System.out.println(myFtp.upload("C:\\Users\\85464\\Downloads\\JetbrainsIdesCrack-3.4-release-enc.jar",
//                    "1.jar"));
            // System.out.println(myFtp.upload("E:\\走西口24.mp4","/央视走西口/新浪网/走西口24.mp4"));
            System.out.println(myFtp.download("1.jar", "C:\\Users\\85464\\Downloads\\2.jar"));
            myFtp.disconnect();
        }
        catch (Exception e)
        {
